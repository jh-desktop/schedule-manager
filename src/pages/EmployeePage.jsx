...
const ROLES = ['감리원', '보조', '기타']
const GRADES = ['전기/특급', '전기/중급', '전기/초급', '토목/특급', '토목/중급', '토목/초급', '기타']
const EMPTY = { name: '', role: '감리원', grade: '전기/초급' }
...
export default function EmployeePage() {
  ...
  return (
    <div style={{ padding: '1rem 1.25rem', maxWidth: '700px', margin: '0 auto' }}>
      ...
      {adding && (
        <div style={{ background: '#fff', border: '2px solid #1e3a5f', borderRadius: '0.75rem', padding: '1.25rem', marginBottom: '1rem' }}>
          ...
          <div style={{ marginBottom: '1rem' }}>
            <label style={labelS}>직종/등급</label>
